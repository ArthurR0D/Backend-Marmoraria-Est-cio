...
# Inicializa o Flask
app = Flask(__name__)
CORS(app) #Permite que o React(front end) se comunique com o Flask


# Configuração do MySQL
load_dotenv()
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://root:JulietaeLana1@@127.0.0.1/loja?charset=utf8mb4' # Utilizando parametros para conectar no Banco de dados, trocar o usuario, senha, localhost e nome do banco de dados.
